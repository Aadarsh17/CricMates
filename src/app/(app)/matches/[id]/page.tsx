...
export default function MatchPage() {
    ...
    const { undoDelivery } = useAppContext();
    ...
    useEffect(() => {
        ...
        if (isOverComplete && !inning.bowlerId && bowlerDialogShownForOver !== inning.overs) {
            ...
            const bowlingTeamPlayers = players.filter(p => bowlingTeamPlayerIds?.includes(p.id));
    ...
    }, [match, isMatchLoading, inningStartDialogShownFor, bowlerDialogShownForOver, players]);
        ...
        <>
            <div className="space-y-4 print:hidden">
                ...
                <SelectBowlerDialog 
                    ...
                    onClose={() => setIsBowlerDialogOpen(false)}
                />
                <Card>
                    <CardHeader>
