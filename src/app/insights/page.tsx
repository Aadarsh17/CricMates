                  ...
                  <CardContent className="p-0">
                    <div className="grid grid-cols-2 sm:grid-cols-3 border-b">
                      {[
                        ...
                        { label: '1 Wicket in Match', count: selectedMilestonePlayer.milestoneSummary.w1, icon: Target, color: 'text-emerald-500' },
                        { label: '2+ Wickets in Match', count: selectedMilestonePlayer.milestoneSummary.w2, icon: Target, color: 'text-emerald-600' },
                        { label: '3+ Wickets in Match', count: selectedMilestonePlayer.milestoneSummary.w3, icon: Trophy, color: 'text-emerald-700' },
